        ...
        <header className="pt-6 pb-6 animate-fade-in flex flex-col items-center text-center relative">
          ...
          <div className="relative mt-5 -mx-5 w-[calc(100%+2.5rem)] sm:-mx-8 sm:w-[calc(100%+4rem)]">
            ...
            <button
              ...
              className="absolute left-4 sm:left-8 top-1/2 -translate-y-1/2 rounded-full ring-4 ring-background shadow-[0_8px_30px_-10px_rgba(0,0,0,0.8)] hover:ring-white/40 transition z-10"
