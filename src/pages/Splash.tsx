  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--gradient-splash)' }}>
      <div className="text-center animate-fade-in px-4">
        ...
        <h1 className="mt-6 sm:mt-8 text-3xl sm:text-4xl font-bold text-white animate-slide-up">
          Hagion AI
        </h1>
        <p className="mt-2 text-sm sm:text-base text-white/90 animate-slide-up">
