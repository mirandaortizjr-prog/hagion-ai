  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        role: "assistant",
        content: "This is where the specialized assistant would provide evidence-based, Scripture-aligned responses. In production, this connects to your AI backend with the assistant's specialized knowledge.",
      };
